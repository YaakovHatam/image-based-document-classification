...
def run_pipeline(
    ...
    for path in pdf_files:
        ...
        base_out_dir = out_root / relative_path.with_suffix("")
        out_dir = base_out_dir
        counter = 1
        while out_dir.exists():
            # If "C:\output\report" exists, this creates "report_1", "report_2", etc.
            new_name = f"{base_out_dir.name}_{counter}"
            out_dir = base_out_dir.with_name(new_name)
            counter += 1
